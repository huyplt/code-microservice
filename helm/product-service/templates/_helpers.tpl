...
{{/*
Helper function: product-service.util.drzew (Default if Local is nil/not boolean, Else use local, fallback to Global, then to ultimate Default)
...
*/}}
{{- define "product-service.util.drzew" -}}
{{- $localEnabled := first . -}}
